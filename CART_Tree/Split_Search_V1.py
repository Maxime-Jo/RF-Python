...
class Best_Splitting_Point:
    ...
    def Splitting(self,split_points): 
        ...
        min_split = np.array(np.where(split_results[:,1] == np.min(split_results[:,1])))
    ...
    def All_Splits(self, sample = None):
        ...
        optimal_split_point = self.Splitting(adjacent_split_points)
    ...
    def Quantile_Split(self, quantiles, sample = None): #User Can specify number of quantiles
        ...
        optimal_split_point = self.Splitting(quantile_split_points)
        return optimal_split_point      
    ...
    def Binning_Split(self, bins, sample = None): #User Can specify number of quantiles
        ...
        optimal_split_point = self.Splitting(binning_split_points)
        return optimal_split_point  
